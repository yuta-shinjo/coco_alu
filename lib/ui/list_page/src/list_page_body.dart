...
import 'package:my_collection/ui/list_page/list_page_model.dart';

import '../../../../widget/index.dart';

class ListPageBody extends StatelessWidget {
  const ListPageBody({required this.creatures, required this.model});
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => EditCreaturePage(creature),
            ),
          );
        },
      ),
