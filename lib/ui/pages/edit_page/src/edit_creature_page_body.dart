...
import 'package:my_collection/ui/pages/edit_page/src/simple_dialog.dart';
    ...
    return Consumer(
      builder: (context, ref, _) {
        final imageFile = ref.watch(
          editCreaturePageProvider.select((s) => s.imageFile),
        );
        final imageUrl = ref.watch(
          editCreaturePageProvider.select((s) => s.creatureImageUrl),
        );
        return Stack(
          children: [
            CircleAvatar(
